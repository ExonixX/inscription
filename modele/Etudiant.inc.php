...
public function get_EDNTID(){
	...
	public function get_EDNTCYCLE(){
		return $this->_EDNTCYCLE;
	}

	public function set_EDNTCYCLE($_EDNTCYCLE){
		$this->_EDNTCYCLE = $_EDNTCYCLE;
	}
	...
	public function get_EDNTCPADRESSETU(){
		return $this->_EDNTCPADRESSETU;
	}

	public function set_EDNTCPADRESSETU($_EDNTCPADRESSETU){
		$this->_EDNTCPADRESSETU = $_EDNTCPADRESSETU;
	}

	public function get_EDNTVILLEADRESSETU(){
		return $this->_EDNTVILLEADRESSETU;
	}

	public function set_EDNTVILLEADRESSETU($_EDNTVILLEADRESSETU){
		$this->_EDNTVILLEADRESSETU = $_EDNTVILLEADRESSETU;
	}
